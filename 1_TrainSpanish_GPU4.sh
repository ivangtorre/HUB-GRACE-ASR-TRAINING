...
# Run the container
set -x
nvidia-docker run -it -d --rm --network=host --name ${CONTAINER} --runtime=nvidia --shm-size=4g --ulimit memlock=-1 --ulimit stack=67108864 -v /DATA/GRACE/IVANbackup/node2/DATA/TMP_IVAN/:/DATA/TMP_IVAN  -w $PWD -v /DATA/GRACE/IVANbackup/node2/DATA/:/DATA/:ro -v /home:/home -v $PWD:/workspace/wav2vec2/ ${NAME}
set +x
