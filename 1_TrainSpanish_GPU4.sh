...
# Run the container
set -x
nvidia-docker run -it -d --rm --name ${CONTAINER} --runtime=nvidia --shm-size=4g --ulimit memlock=-1 --ulimit stack=67108864 -v /data/TMP_IVAN/:/data/TMP_IVAN  -w $PWD -v /data/:/data/:ro -v /home:/home -v $PWD:/workspace/wav2vec2/ ${NAME}
set +x
