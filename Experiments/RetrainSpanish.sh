...
DATASET=${2:-${DATASET:-"/DATA/TMP_IVAN/GRACE/datasets/spanish/train_with_speed_augment.csv"}}  # Train Dataset Location
...
MODELXLSR=${4:-${MODELXLSR:-"/home/igonzalez/HUB-GRACE-ASR-TRAINING/models/spanish.-EPOCH-10.-21-09-17.15.35.43"}}
...
SAVE_STATES=${14:-${SAVE_STATES:-10000}}
EVAL_STATES=${15:-${EVAL_STATES:-10000}}
LOG_STATES=${16:-${LOG_STATES:-5000}}
...
#mkdir -p "$RESULT_DIR"
RESULT_DIR="results/spanish.-EPOCH-10.-21-09-17.15.35.43"
