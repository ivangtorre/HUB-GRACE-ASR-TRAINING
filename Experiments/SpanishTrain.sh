...
DATASET=${2:-${DATASET:-"/DATA/TMP_IVAN/jasper/datasets/spanish/train_with_speed_augment.csv"}}
DATASET_EVAL=${2:-${DATASET_EVAL:-"/DATA/TMP_IVAN/jasper/datasets/spanish/tests/test_ES_RTVE.csv"}}  # Eval Dataset Location
